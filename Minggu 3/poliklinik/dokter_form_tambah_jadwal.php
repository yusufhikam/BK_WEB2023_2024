                    ...
                    <div class="row">
                        <div class="col">
                                ...
                                <div class="card card-primary">
                                    ...
                                    <!-- /.card-header -->
                                    <!-- form start -->
                                    <form action="conf/dokter_proses_tambah_jadwal.php" method="post">
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="time" class="form-control" id="jam_mulai" name="jam_mulai" value="" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="jam_selesai">Jam Selesai</label>
                                                <input type="time" class="form-control" id="jam_selesai" name="jam_selesai" value="" required>
                                            </div>
