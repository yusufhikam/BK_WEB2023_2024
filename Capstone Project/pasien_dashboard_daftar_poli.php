                                    ...
                                    <?php
                                        ...
                                        while ($data = $result->fetch_assoc()) {
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $data['status'] == 'Sudah Diperiksa' ? 'Sudah Diperiksa' : 'Belum Diperiksa'; ?></td>
                                                <td>
                                                    <!-- Tombol detail -->
                                                    <button type="button" class="btn btn-success btn-sm btn-detail"
                                                        data-no-antrian="<?php echo $data['no_antrian']; ?>"
                                                        data-poli="<?php echo $data['nama_poli']; ?>"
                                                        data-dokter="<?php echo $data['nama_dokter']; ?>"
                                                        data-jam-mulai="<?php echo $data['jam_mulai']; ?>"
                                                        data-jam-selesai="<?php echo $data['jam_selesai']; ?>"
