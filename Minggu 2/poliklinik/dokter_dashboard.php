                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        if(isset($_SESSION['id_dokter'])){
                                            ...
                                            $result = $koneksi->query("SELECT dp.id_pasien, dp.keluhan, dp.no_antrian, ps.nama
                                                                    FROM daftar_poli dp JOIN pasien ps ON dp.id_pasien=ps.id
                                                                    JOIN jadwal_periksa jp ON dp.id_jadwal = jp.id WHERE jp.id_dokter = '$id_dokter'
                                            ...
                                            while ($data = $result->fetch_assoc()) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="dokter_form_periksa.php?id_pasien=<?php echo $data['id_pasien']; ?>"><button class="btn btn-primary">Edit</button></a>
                                                    </td>
                                                </tr>
                                                <?php
                                            }
