                            ...
                            <form action="conf/pasien_proses_daftar_poli.php" method="post">
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <div><?php echo $no_rm_pasien; ?></div>                                    </div>
                                    <div class="form-group">
                            ...
                            <div class="card-body">
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        $query = "SELECT dp.no_antrian, p.nama_poli, d.nama AS nama_dokter, jp.hari, jp.jam_mulai, jp.jam_selesai
                                          FROM daftar_poli dp
                                        ...
                                        while ($data = $result->fetch_assoc()) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <!-- Tombol Ubah -->
                                                    <a href="#" class="btn btn-warning btn-sm" data-toggle="modal" data-target="#ubahModal<?php echo $data['no_antrian']; ?>">Ubah</a>
                                                    <!-- Tombol Hapus -->
                                                    <a href="#" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#hapusModal<?php echo $data['no_antrian']; ?>">Hapus</a>
                                                </td>
                                            </tr>
                                            <?php
                                        }
